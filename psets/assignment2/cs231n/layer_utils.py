...
def affine_bn_relu_forward(x, w, b, gamma, beta, bn_param):
    """Forward pass of affine-batchnorm-relu layer."""
    a, fc_cache = affine_forward(x, w, b)
...
def affine_bn_relu_backward(dout, cache):
    """Backward pass of affine-batchnorm-relu layer."""
...
def affine_ln_relu_forward(x, w, b, gamma, beta, ln_param):
    """Forward pass of affine-layernorm-relu layer."""
    a, fc_cache = affine_forward(x, w, b)
...
def affine_ln_relu_backward(dout, cache):
    """Backward pass of affine-layernorm-relu layer."""
